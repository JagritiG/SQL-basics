...
-- Create a table by defining a FOREIGN KEY constraint
CREATE TABLE Orders (
...
-- Create multi-column Foreign key constraint on Customer_ID column when Orders table is already created
ALTER TABLE Orders
...
ALTER TABLE Orders
DROP CONSTRAINT FK_Customer_ID_Order;
